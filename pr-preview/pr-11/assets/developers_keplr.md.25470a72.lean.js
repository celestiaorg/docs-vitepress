...
`),X,n(`
`),z,n(`
`),s("span",Y,[s("span",L,"  chainId: '"+l(a.constants.mochaChainId)+"',",1)]),n(`
`),Q,n(`
`),s("span",W,[s("span",$,"  rpc: '"+l(a.constants.mochaRpcUrl)+"',",1)]),n(`
