...
`),Z,n(`
`),z,n(`
`),s("span",J,[s("span",Y,"  chainId: '"+l(a.constants.mochaChainId)+"',",1)]),n(`
`),L,n(`
`),s("span",Q,[s("span",$,"  rpc: '"+l(a.constants.mochaRpcUrl)+"',",1)]),n(`
