...
`),O,n(`
`),j,n(`
`),G])]),s("pre",H,[s("code",null,[J,n(`
`),Q,n(`
`),W,n(`
`),s("span",X,[s("span",Y,"  chainId: '"+l(a.constants.mochaChainId)+"',",1)]),n(`
`),$,n(`
