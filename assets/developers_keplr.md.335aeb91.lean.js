...
`),Y,n(`
`),X,n(`
`),s("span",Q,[s("span",W,"  chainId: '"+l(a.constants.mochaChainId)+"',",1)]),n(`
`),$,n(`
...
`),fs,n(`
`),s("span",Bs,[s("span",Ts,"  rpc: '"+l(a.constants.arabicaRpcUrl)+"',",1)]),n(`
