...
`),G,n(`
`),H,n(`
`),O])]),s("pre",j,[s("code",null,[J,n(`
`),W,n(`
`),X,n(`
`),s("span",Y,[s("span",Q,"  chainId: '"+l(a.constants.mochaChainId)+"',",1)]),n(`
`),$,n(`
`),s("span",z,[s("span",L,"  rpc: '"+l(a.constants.mochaRpcUrl)+"',",1)]),n(`
...
`),As,n(`
`),ms,n(`
`),Cs])]),s("pre",ws,[s("code",null,[bs,n(`
`),qs,n(`
`),ks,n(`
`),s("span",Ds,[s("span",gs,"  chainId: '"+l(a.constants.arabicaChainId)+"',",1)]),n(`
`),Ts,n(`
`),s("span",fs,[s("span",Bs,"  rpc: '"+l(a.constants.arabicaRpcUrl)+"',",1)]),n(`
